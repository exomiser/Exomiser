package org.monarchinitiative.exomiser.core.prioritisers.phenodigm;
...
public class PhenotypeMatchServiceTest {
    ...
    public void testIntegrationWithModelScorer() {
        ...
        OrganismPhenotypeMatcher hpHpQueryMatcher = instance.getHumanPhenotypeMatcherForTerms(queryTerms);

        ModelScorer modelScorer = ModelScorer.forSameSpecies(hpHpQueryMatcher);
