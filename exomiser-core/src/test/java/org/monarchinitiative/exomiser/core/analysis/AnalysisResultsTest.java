...
class AnalysisResultsTest {
    ...
    @Test
    void defaultConstructorInitialisesGenesVariantEvalations() {
        AnalysisResults instance = AnalysisResults.builder().build();
        assertThat(instance.sample(), equalTo(Sample.builder().build()));
        assertThat(instance.analysis(), equalTo(Analysis.builder().build()));
        assertThat(instance.genes(), equalTo(Collections.emptyList()));
        assertThat(instance.variantEvaluations(), equalTo(Collections.emptyList()));
    }
    ...
    void testSample() {
        ...
        assertThat(instance.probandSampleName(), equalTo(sample.probandSampleName()));
        assertThat(instance.sample(), equalTo(sample));
    }

    @Test
    void testCanSetAndGetSampleNames() {
        ...
        assertThat(instance.sampleNames(), equalTo(sampleNames));
    }

    @Test
    void testCanSetAndGetVariantEvaluations() {
        List<VariantEvaluation> variantEvaluations = new ArrayList<>();
        AnalysisResults instance = AnalysisResults.builder()
                .variantEvaluations(variantEvaluations)
                .build();
        assertThat(instance.variantEvaluations(), equalTo(variantEvaluations));
    }

    @Test
    void testCanSetAndGetGenes() {
    ...
    @Test
    void testGetGeneScoresReturnsEmptyListWithNoResults() {
        AnalysisResults empty = AnalysisResults.builder().build();
        assertThat(empty.geneScores(), equalTo(Collections.emptyList()));
    }

    @Test
    void testGetGeneScores() {
        //
        ...
        GeneScore second = GeneScore.builder()
                .geneIdentifier(rbm8aGene.geneIdentifier())
                .modeOfInheritance(ModeOfInheritance.AUTOSOMAL_DOMINANT)
                .combinedScore(0.75f)
        ...
        assertThat(instance.geneScores(), equalTo(expected));
    }

    @Test
    void testGetGeneScoresForMode() {
        Gene fgfr2Gene = TestFactory.newGeneFGFR2();
        VariantEvaluation top = TestFactory.variantBuilder(10, 23456, "G", "T").build();
        ...
        assertThat(instance.geneScoresForMode(ModeOfInheritance.AUTOSOMAL_DOMINANT), equalTo(List.of(firstAD, secondAD)));
        assertThat(instance.geneScoresForMode(ModeOfInheritance.AUTOSOMAL_RECESSIVE), equalTo(List.of(thirdAR)));
    }

    @Test
    void testCanReturnUnannotatedVariantEvaluations() {
        VariantEvaluation annotatedVariantEvaluation = TestFactory.variantBuilder(10, 123353297, "G", "C")
                .transcriptAnnotations(Collections.singletonList(TranscriptAnnotation.empty()))
                .build();
        ...
        assertThat(instance.unAnnotatedVariantEvaluations(), equalTo(unAnnotatedVariantEvaluations));
    }
    ...
    void noFilterCounts() {
        AnalysisResults instance = AnalysisResults.builder()
                .build();
        assertThat(instance.filterCounts(), equalTo(Collections.emptyList()));
        assertThat(instance.filterCountForType(FilterType.FREQUENCY_FILTER), equalTo(new FilterResultCount(FilterType.FREQUENCY_FILTER, 0, 0)));
    }
    ...
    void filterCounts() {
        ...
        assertThat(instance.filterCounts(), equalTo(filterResultCounts));
        assertThat(instance.filterCountForType(FilterType.FREQUENCY_FILTER), equalTo(freqFilterResultCount));
        assertThat(instance.filterCountForType(FilterType.PATHOGENICITY_FILTER), equalTo(pathFilterResultCount));
        assertThat(instance.filterCountForType(FilterType.VARIANT_EFFECT_FILTER), equalTo(new FilterResultCount(FilterType.VARIANT_EFFECT_FILTER, 0, 0)));
    }
