...
public class ChromosomalRegionIndexTest {
    ...
    public void empty() {
        ...
        assertThat(emptyTopoDomainIndex.getRegionsContainingVariant(variant), equalTo(List.of()));
        assertThat(emptyRegulatoryFeatureIndex.getRegionsContainingVariant(variant), equalTo(List.of()));
    ...
    public void emptyListIntoOfConstructor() {
        ChromosomalRegionIndex<RegulatoryFeature> empty = ChromosomalRegionIndex.of(List.of());
    }

    @Test
    public void multipleRegionsInChromosomes() {
        TopologicalDomain region1 = new TopologicalDomain(1, 1, 100, Map.of());
        TopologicalDomain region2 = new TopologicalDomain(1, 150, 300, Map.of());
        TopologicalDomain region3 = new TopologicalDomain(1, 250, 350, Map.of());
        TopologicalDomain region4 = new TopologicalDomain(1, 400, 500, Map.of());
        TopologicalDomain region5 = new TopologicalDomain(2, 600, 800, Map.of());

        List<TopologicalDomain> chromosomalRegions = List.of(region1, region2, region3, region4, region5);
    ...
    public void testGetTadsContainingVariantSingleTad() {
        TopologicalDomain tad = new TopologicalDomain(1, 1, 100, Map.of());
        ChromosomalRegionIndex<TopologicalDomain> instance = ChromosomalRegionIndex.of(List.of(tad));

        assertThat(instance.getRegionsContainingVariant(variant), equalTo(List.of(tad)));
    ...
    public void testGetTadsContainingVariantSingleTadVariantNotInTad() {
        TopologicalDomain tad = new TopologicalDomain(1, 1, 10, Map.of());
        ChromosomalRegionIndex<TopologicalDomain> instance = ChromosomalRegionIndex.of(List.of(tad));

        assertThat(instance.getRegionsContainingVariant(variant), equalTo(List.of()));
    ...
    public void testGetTadsContainingPositionPositionOneBeforeStartOfRegion() {
        TopologicalDomain tad = new TopologicalDomain(1, 10, 12, Map.of());
        ChromosomalRegionIndex<TopologicalDomain> instance = ChromosomalRegionIndex.of(List.of(tad));

        assertThat(instance.getRegionsOverlappingPosition(1, 9), equalTo(List.of()));
    }
    ...
    public void testGetTadsContainingPositionPositionAtStartOfRegion() {
        ...
        assertThat(instance.getRegionsOverlappingPosition(1, 10), equalTo(List.of(tad)));
    }
    ...
    public void testGetTadsContainingPositionPositionMiddleOfRegion() {
        ...
        assertThat(instance.getRegionsOverlappingPosition(1, 11), equalTo(List.of(tad)));
    }
    ...
    public void testGetTadsContainingPositionPositionAtEndOfRegion() {
        ...
        assertThat(instance.getRegionsOverlappingPosition(1, 12), equalTo(List.of(tad)));
    }
    ...
    public void testGetTadsContainingPositionPositionOneAfterEndOfRegion() {
        ...
        assertThat(instance.getRegionsOverlappingPosition(1, 13), equalTo(List.of()));
    }

    @Test
    public void testGetTadsContainingVariantTwoNonOverlappingTads() {
        TopologicalDomain tad = new TopologicalDomain(1, 1, 100, Map.of());
        TopologicalDomain tad1 = new TopologicalDomain(2, 200, 300, Map.of());
        ChromosomalRegionIndex<TopologicalDomain> instance = ChromosomalRegionIndex.of(List.of(tad, tad1));
    ...
    public void testGetTadsContainingVariantTwoOverlappingTadsVariantInBoth() {
        TopologicalDomain tad = new TopologicalDomain(1, 1, 100, Map.of());
        TopologicalDomain tad1 = new TopologicalDomain(1, 25, 75, Map.of());
        ChromosomalRegionIndex<TopologicalDomain> instance = ChromosomalRegionIndex.of(List.of(tad, tad1));

        assertThat(instance.getRegionsContainingVariant(variant), equalTo(List.of(tad, tad1)));
    }

    @Test
    public void testGetTadsContainingVariantTwoOverlappingTadsVariantInOne() {
        TopologicalDomain tad = new TopologicalDomain(1, 1, 100, Map.of());
        TopologicalDomain tad1 = new TopologicalDomain(1, 75, 200, Map.of());
        ChromosomalRegionIndex<TopologicalDomain> instance = ChromosomalRegionIndex.of(List.of(tad, tad1));
