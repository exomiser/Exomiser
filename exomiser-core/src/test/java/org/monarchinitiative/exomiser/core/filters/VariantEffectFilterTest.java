...
public class VariantEffectFilterTest {
    ...
    @Test
    void testWhiteListedSynonymousVariantPasses() {
        VariantEvaluation whitListedSynonymousVariant = testVariantBuilder()
                .variantEffect(VariantEffect.SYNONYMOUS_VARIANT)
                .whiteListed(true)
                .build();

        FilterResult filterResult = instance.runFilter(whitListedSynonymousVariant);
