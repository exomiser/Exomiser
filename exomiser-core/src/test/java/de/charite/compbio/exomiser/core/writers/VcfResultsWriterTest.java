...
public class VcfResultsWriterTest {
    ...
    public void before() throws AnnotationException {
        ...
        settings = new ExomiserSettings.SettingsBuilder().vcfFilePath(Paths.get("dummyVcfPath"))
                .usePrioritiser(PriorityType.OMIM_PRIORITY).outputFormats(EnumSet.of(OutputFormat.VCF)).build();
    ...
    private void setUpSampleData() {
        ...
        passVariantVcfString = "chr1	1	.	A	T	2.2	PASS	;EXOMISER_GENE=ABC1;EXOMISER_VARIANT_SCORE=1.0;EXOMISER_GENE_PHENO_SCORE=0.0;EXOMISER_GENE_VARIANT_SCORE=0.0;EXOMISER_GENE_COMBINED_SCORE=0.0	GT	0/1\n";
        ...
        failOneFilterVariantVcfString = "chr1	2	.	T	-	2.2	Target	;EXOMISER_GENE=ABC1;EXOMISER_VARIANT_SCORE=0.0;EXOMISER_GENE_PHENO_SCORE=0.0;EXOMISER_GENE_VARIANT_SCORE=0.0;EXOMISER_GENE_COMBINED_SCORE=0.0	GT	0/1\n";
        ...
        failTwoFilterVariantVcfString = "chr2	3	.	C	T	2.2	Frequency;Target	;EXOMISER_GENE=CDE2;EXOMISER_VARIANT_SCORE=0.0;EXOMISER_GENE_PHENO_SCORE=0.0;EXOMISER_GENE_VARIANT_SCORE=0.0;EXOMISER_GENE_COMBINED_SCORE=0.0	GT	0/1\n";
        ...
        // we're not going to add any filters to this in order to test that this is reported properly according to the
        // VCF
        spec.
        ...
        unFilteredVariantVcfString = "chr3	5	.	G	C	2.2		;EXOMISER_GENE=CDE2;EXOMISER_VARIANT_SCORE=1.0;EXOMISER_GENE_PHENO_SCORE=0.0;EXOMISER_GENE_VARIANT_SCORE=0.0;EXOMISER_GENE_COMBINED_SCORE=0.0	GT	0/1\n";
