...
public class TsvVariantResultsWriterTest {
    ...
    // ExomiserSettings.SettingsBuilder().outFileName("testWrite").outputFormats(EnumSet.of(OutputFormat.TSV_VARIANT)).build();
    ...
    // ExomiserSettings settings = new
    // ExomiserSettings.SettingsBuilder().outputFormats(EnumSet.of(OutputFormat.TSV_VARIANT)).build();
