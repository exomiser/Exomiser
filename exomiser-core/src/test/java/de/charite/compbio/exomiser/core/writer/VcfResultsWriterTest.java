...
import de.charite.compbio.exomiser.core.filter.InheritanceFilterResult;
...
public class VcfResultsWriterTest {
    ...
    private void setUpSampleData() {
        ...
        //we're not going to add any filters to this in order to test that this is reported properly according to the VCF spec.
