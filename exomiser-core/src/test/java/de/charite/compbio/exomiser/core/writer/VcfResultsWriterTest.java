...
public class VcfResultsWriterTest {
    ...
    private static final String PASS_VARIANT_STRING = "chr1	1	.	A	T	2.2	PASS	GENE=.;PHENO_SCORE=0.0;VARIANT_SCORE=0.0;COMBINED_SCORE=0.0	GT	0/1\n";
    private static final FilterType FAIL_FILTER_TYPE = FilterType.PATHOGENICITY_FILTER;
    private static final String FAIL_VARIANT_STRING = String.format("chr1	2	.	T	-	2.2	%s	GENE=.;PHENO_SCORE=0.0;VARIANT_SCORE=0.0;COMBINED_SCORE=0.0	GT	0/1\n", FAIL_FILTER_TYPE.toString());
