...
public class IntervalFilterTest {
    ...
    // FIXME(holtgrew): Uncomment lines agains.
    ...
    // String expected = String.format("%s filter chromosome=%d, from=%d, to=%d, interval=%s", instance.getFilterType(),
    // RIGHT_CHR, START_REGION, END_REGION, SEARCH_INTERVAL);
