...
public class FrequencyData {
    ...
    /**
     *
     * @return the number of frequency objects in this instance
     * @since 14.0.0
     */
    public int size() {
        return size;
    ...
    /**
     *
     * @return true if the size is zero and the rsId is empty.
     */
    public boolean isEmpty() {
        return size == 0 && rsId.isEmpty();
    }
    ...
    /**
     * Returns the maximum frequency - if there are no known frequencies or no frequency data it will return 0.
     *
     * @return
     */
    @JsonIgnore
