 ...
 *
 */
public record SampleData(String id, SampleGenotype sampleGenotype, CopyNumber copyNumber) {

    public SampleData {
        Objects.requireNonNull(id);
        Objects.requireNonNull(sampleGenotype);
        Objects.requireNonNull(copyNumber);
    }
