...
public final class VariantEffectPathogenicityScore {
    ...
    /**
     * This is the pathogenicity value we will give to missense (non-synonymous)
    ...
    public static float pathogenicityScoreOf(VariantEffect variantEffect) {
        return switch (variantEffect) {
            ...
            case MNV, FEATURE_TRUNCATION, DISRUPTIVE_INFRAME_DELETION, DISRUPTIVE_INFRAME_INSERTION, INFRAME_DELETION,
                 INFRAME_INSERTION, INTERNAL_FEATURE_ELONGATION, COMPLEX_SUBSTITUTION -> NONFRAMESHIFT_INDEL_SCORE;
    ...
    private static float defaultImpactScore(PutativeImpact putativeImpact) {
        return switch (putativeImpact) {
            case HIGH -> DEFAULT_HIGH_SCORE;
            case MODERATE -> DEFAULT_MISSENSE_SCORE;
            case LOW, MODIFIER -> NON_PATHOGENIC_SCORE;
        };
    }
