 ...
 *
 * @param maxFreq Threshold for filtering. Retain only those variants whose frequency
 *                (expressed as a percentage) is below this threshold. The default frequency is
 *                100%, i.e., no filtering out.
 * @author Peter N Robinson
 * @author Jules Jacobsen <jules.jacobsen@sanger.ac.uk>
 * @version 0.09 (April 28, 2013)
 */
public record FrequencyFilter(float maxFreq) implements VariantFilter {
