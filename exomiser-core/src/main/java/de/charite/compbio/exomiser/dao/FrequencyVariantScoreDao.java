...
/**
 * DAO class for retrieving {@code de.charite.compbio.exomiser.fFrequencyVariantScoreTriage}
 * objects for from the database.
 *
 * @author Jules Jacobsen <jules.jacobsen@sanger.ac.uk>
 */
@Repository
public class FrequencyVariantScoreDao implements VariantScoreDao {

    private final Logger logger = LoggerFactory.getLogger(FrequencyVariantScoreDao.class);

    @Autowired
    private DataSource dataSource;

    public FrequencyVariantScoreDao() {
        
    }
    
    public FrequencyVariantScoreDao(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    @Override
    public FrequencyVariantScore getVariantScore(Variant variant) {
        ...
        try (
            ...
            return processVariantScoreResults(rs);
    ...
    private FrequencyVariantScore processVariantScoreResults(ResultSet rs) throws SQLException {
