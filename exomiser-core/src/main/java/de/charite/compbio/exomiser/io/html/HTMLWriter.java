...
/**
 * This class is responsible for creating the framework of the HTML page that is
 * created by the Exomiser for each VCF analysis. It writes out the CSS elements
 * and the constant parts of the HTML page.
 * <P>
...
public class HTMLWriter {
    ...
    /**
     * maximum number of genes that will be shown (default 100). This parameter
     * can be set to 10,20,50,All on the PhenIX and ExomeWalker servers.
     */
    ...
    /**
     * Some of the prioritization methods start from seed genes. They are
     * lisated here. For example, ExomeWalker starts off with Entrez Gene genes
     * to do the random walk analysis.
     */
    protected List<String> seedGeneList = null;
    /**
     * This object can display network-type information about genes. It can be
     * used to represent relationships between candidate genes (e.g., STRING
     * interactions).
     */
    ...
    /**
     * The disease gene family that is the basis of the genes in the list of
     * seed genes (see {@link #seedGeneList}).
     */
    ...
    /**
     * @param lst A list of HGMD entries (mutations) that have been found in the
     * database.
     */
     ...
     * @param basename The basename of the VCF file.
     */
    public HTMLWriter(String fname, String basename) {
        this(fname);
        this.vcfBasename = basename;
    }

    /**
     * Add a list of HPO terms used to prioritze genes. Intended to allow the
     * terms to be displayed on the HTML page, this function does not actually
     * do analysis. Note that the method needs to be implemented by subclasses,
     * here it is a no-op.
     */
    ...
    /**
     * This function outputs an HTML header together with CSS code and a
     * top-menu with links to the divers sections of the page.
     */
    ...
    /**
     * Write the very beginning of the HTML file, with the DOCTYPE declaration
     * and the title. After this segment, if desired, one should write CSS using
     * the function {@link #writeCSS} in this class or another function (e.g.,
    ...
    /**
     * Write the closing tags for the HTML head and write the opening tag for
     * the HTML body.
     */
     ...
     */
    public void writeHTMLFilterSummary(List<FilterReport> filterReports, List<Priority> priorityList) throws IOException {
    ...
    /**
     * Writes a textbox with the results of the search for variants that are
     * contained in the HGMD Pro database.
     *
     ...
     * It first closes the div section for the MAIN part of the HTML page and
     * then writes out a footer bar, and closes the HTML element.
     */
