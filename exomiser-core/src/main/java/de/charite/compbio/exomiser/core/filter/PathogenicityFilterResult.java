 ...
 *
 */
public class PathogenicityFilterResult extends GenericFilterResult {

    private static final Logger logger = LoggerFactory.getLogger(PathogenicityFilterResult.class);

    private static final FilterType FILTER_TYPE = FilterType.PATHOGENICITY_FILTER;
            
    public PathogenicityFilterResult(float pathogenicityScore, FilterResultStatus resultStatus) {
