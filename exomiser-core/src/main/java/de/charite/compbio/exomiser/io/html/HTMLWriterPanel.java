...
public class HTMLWriterPanel extends HTMLWriter {
     ...
     */
    public HTMLWriterPanel(String fname) {
        super(fname);
    }
    ...
    public void writeTopMenu() throws IOException {
        out.write("<div class=\"container\">\n"
                + /* Div stack height 1 */ "<h2>Gene Panel Analysis</h2>\n"
                + "<hr>\n");
        ...
        out.write("<div class=\"grid_L omega colborder\">\n"
                +/* Div stack height 3 */ "<p><strong>Gene Paneliser</strong> is a computational method to prioritise a set of candidates "
