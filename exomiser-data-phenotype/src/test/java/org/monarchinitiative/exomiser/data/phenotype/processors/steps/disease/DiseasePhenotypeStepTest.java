 ...
 */
class DiseasePhenotypeStepTest {
    ...
    void run(@TempDir Path tempDir) {
        ...
        Path outFilePath = tempDir.resolve("diseaseHp.pg");
        OutputLineWriter<DiseasePhenotype> diseasePhenotypeWriter = new OutputLineWriter<>(outFilePath);

        DiseasePhenotypeStep instance = DiseasePhenotypeStep.create(phenotypeAnnotationResource, diseasePhenotypeWriter);
        instance.run();
