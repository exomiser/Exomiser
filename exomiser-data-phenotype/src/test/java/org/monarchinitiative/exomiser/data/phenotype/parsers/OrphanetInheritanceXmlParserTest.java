...
class OrphanetInheritanceXmlParserTest {
    ...
    void getDisease2inheritanceMultimap() {
        OrphanetInheritanceXmlParser instance = new OrphanetInheritanceXmlParser("src/test/resources/data/en_product9_ages.xml");

        Multimap<String, InheritanceMode> disease2inheritanceMultimap = instance.getDisease2inheritanceMultimap();
