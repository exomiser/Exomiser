...
public class OrphanetInheritanceXmlParser {
     ...
     */
    private final Multimap<String, InheritanceMode> disease2inheritanceMultimap;
    // XML Parsing
    ...
    public OrphanetInheritanceXmlParser(String xmlpath) {
        orphanetXmlPath = xmlpath;
        disease2inheritanceMultimap = ArrayListMultimap.create();
        parse(new File(orphanetXmlPath));
    }

    public Multimap<String, InheritanceMode> getDisease2inheritanceMultimap() {
                ...
                if (event.isStartElement()) {
                    ...
                    if (localPart.equals(DISORDER)) {
                        ...
                        if (countAttribute == null || "0".equals(countAttribute.getValue())) {
                            ...
                            logger.info("Skipping ORPHA:{} {} due to no known MOI", currentOrphanum, currentDiseaseName);
                        }
                        ...
                        if (inheritanceMode != null) {
                            ...
                            logger.info("{} {} {} {}", disId, currentModeOfInheritanceLabel, inheritanceMode.getInheritanceCode(), currentDiseaseName);
                            this.disease2inheritanceMultimap.put(disId, inheritanceMode);
                        }
