...
public class FishGeneLabelParser implements ResourceParser {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FishGeneLabelParser.class);

    private final Map<String, String> fishIdtoSymbol;

    public FishGeneLabelParser(Map<String, String> fishId2Symbol) {
        this.fishIdtoSymbol = fishId2Symbol;
    }
