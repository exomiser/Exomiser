...
public class PhenoWandererRelevanceScore implements IRelevanceScore,Constants  {
     ...
     */
    public PhenoWandererRelevanceScore(double score, String evidence) {
     ...
     */
    public static PhenoWandererRelevanceScore noPPIDataScore() {
	float nodatascore = 0f;
	PhenoWandererRelevanceScore grs = new PhenoWandererRelevanceScore(nodatascore,"no evidence");
	return grs;
    }
