 ...
 * <P>
 * Note that classes that implement the interface {@link exomizer.priority.Priority IPriority}
...
public interface Filter {
    ...
    public void filterVariants(List<VariantEvaluation> varianEvaluationtList);
