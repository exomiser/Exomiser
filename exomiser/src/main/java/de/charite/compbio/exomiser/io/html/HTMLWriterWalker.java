...
public class HTMLWriterWalker extends HTMLWriter {
     ...
     */
    public HTMLWriterWalker(String fname) throws ExomizerInitializationException {
	super(fname);
    }
	...
	out.write("<div class=\"container\">\n"+  /* Div stack height 1 */
	 ...
	 out.write("<div class=\"grid_L omega colborder\">\n"+/* Div stack height 3 */
		  "<p><strong>EXOME WALKER</strong> is a computational method to prioritise a set of candidates "+
     ...
     */
    @Override public void writeHTMLFilterSummary(List<IFilter> filterList, 
