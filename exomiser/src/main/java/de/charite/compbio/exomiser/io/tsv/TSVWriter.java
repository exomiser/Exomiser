...
public class TSVWriter {
     ...
     */
    public TSVWriter(String fname) throws ExomizerInitializationException {
        try {
    ...
    public void writeTSV(List<Gene> geneList, String candidateGene)
        ...
        for (Gene g : geneList) {
            ...
            for (FilterType i : g.relevanceMap.keySet()) {
                RelevanceScore r = g.relevanceMap.get(i);
            ...
            for (VariantEvaluation ve : g.variant_list) {
