...
public class DynamicPhenodigmRelevanceScore implements IRelevanceScore {
     ...
     */
    public DynamicPhenodigmRelevanceScore(String mgi_id,String gene, float PHENODIGM_MGI) {
	this.MGI_ID = mgi_id;
   ...
   public static DynamicPhenodigmRelevanceScore createNoDataRelevanceObject()
    {
	DynamicPhenodigmRelevanceScore rscore = new DynamicPhenodigmRelevanceScore(null,null, Constants.UNINITIALIZED_FLOAT);
	return rscore;
    }
