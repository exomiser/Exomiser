...
public class FrequencyTriage implements Triage {
    ...
    public static void setMaxFreqThreshold(float maxFreq) throws ExomizerInitializationException {
        ...
        FrequencyTriage.threshold = maxFreq;
    }
    ...
    public boolean passesFilter() {
        if (dbSNPmaf > FrequencyTriage.threshold) {
            return false;
        } else if (espAllmaf > FrequencyTriage.threshold) {
            return false;
        } else if (espEAmaf > FrequencyTriage.threshold) {
            return false;
        } else if (espAAmaf > FrequencyTriage.threshold) {
            return false;
        } else {
            return true;
        }
