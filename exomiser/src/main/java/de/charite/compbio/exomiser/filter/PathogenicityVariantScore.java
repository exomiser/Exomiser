 ...
 *
 */
public class PathogenicityVariantScore implements VariantScore {

    private static final Logger logger = LoggerFactory.getLogger(PathogenicityVariantScore.class);
    /**
     ...
     */
    public PathogenicityVariantScore(float poly, float mt, float SIFT, float CADD) {
        this.polyphen = poly;
     ...
     */
    public PathogenicityVariantScore(VariantType type, float pathogenicity, float CADD) {
    ...
    public static void setUseMissenseFiltering(boolean useMisSenseFiltering) {
        PathogenicityVariantScore.useMisSenseFiltering = useMisSenseFiltering;
    }

    
    /**
     * Sets the Pathogenicity score threshold to 0. This is redundant using the new
     * @deprecated
     */
    @Deprecated
    public static void keepSynonymousVariants() {
        logger.info("SETTING PATHOGENICITY_SCORE_THRESHOLD TO 0");
        PathogenicityVariantScore.PATHOGENICITY_SCORE_THRESHOLD = 0;
    }
    ...
    /**
     * This method creates a PathogenicityVariantScore object for certain kinds of
 variants. Note that NONSYNONYMOUS variants are not evaluated in this way,
     ...
     */
    public static PathogenicityVariantScore evaluateVariantClass(Variant v, float CADD) {
     ...
     */
    public static PathogenicityVariantScore createNoDataTriageObject() {
        PathogenicityVariantScore pt = new PathogenicityVariantScore(Constants.UNINITIALIZED_FLOAT, Constants.UNINITIALIZED_FLOAT, Constants.UNINITIALIZED_FLOAT, Constants.UNINITIALIZED_FLOAT);
        return pt;
    }

    /**
     * This method creates a PathogenicityVariantScore object for a variant that we
 have judged to be non-pathogenic.
     */
    public static PathogenicityVariantScore createNonPathogenicTriageObject(VariantType type, float CADD) {
        PathogenicityVariantScore pt = new PathogenicityVariantScore(type, NON_PATHOGENIC, CADD);
        return pt;
    }
 ...
 variants such as NONSENSE, FRAMESHIFT, etc.
     */
    public static PathogenicityVariantScore createPathogenicTriageObjectByType(VariantType type, float score, float CADD) {
        PathogenicityVariantScore pt = new PathogenicityVariantScore(type, score, CADD);
        return pt;
    }
}
