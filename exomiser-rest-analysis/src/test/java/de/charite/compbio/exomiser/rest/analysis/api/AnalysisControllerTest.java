...
import de.charite.compbio.exomiser.rest.analysis.ExomiserAnalysisServer;
...
@SpringBootTest(classes = {ExomiserAnalysisServer.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
